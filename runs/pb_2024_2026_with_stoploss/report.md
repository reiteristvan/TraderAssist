...
| Median post-stop MFE | +0.21R |
| Winners' MAE near −1R (≤ −0.75) | 17% |

**Branch B** — 11% of stopped trades subsequently reached target (post-stop MFE median +0.21R) — stopped trades continued lower, consistent with genuine breakdown (Branch B: setups may lack edge at the current stop level → evaluate entry quality via E14.3/E14.4).
...
|----------|---|----------|------|
| 1.0–1.5×R | 249 | 37% | 0.109 |
| 1.5–2.0×R | 211 | 23% | -0.045 |
| 2.0–2.5×R | 183 | 21% | 0.020 |
| 2.5–3.0×R | 161 | 14% | 0.010 |
| 3.0+×R | 664 | 11% | 0.394 |
...
|----------|---|----------|------|
| <1.0 ATR | 66 | 73% | 0.039 |
| 1.0–1.5 ATR | 58 | 43% | -0.112 |
| 1.5–2.0 ATR | 322 | 39% | 0.164 |
| 2.0–2.5 ATR | 371 | 29% | 0.303 |
| 2.5+ ATR | 806 | 8% | 0.166 |
...
|------|---------------|----------------|----------------|------|---------|
| 200-MA distance in range | 374 | -0.086 | 0.182 | -0.268 | questionable gate value (near-misses match or beat qualified) |
...
| Near 52w high in last 60d | 431 | -0.015 | 0.182 | -0.197 | questionable gate value (near-misses match or beat qualified) |
